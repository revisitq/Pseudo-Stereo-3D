...
class KittiData:
    ...
    def __init__(self, root_dir, idx, output_dict=None):
        ...
        self.image3_path = os.path.join(root_dir, 'image_2_dorn', idx+'.png')
    ...
    def read_data(self):
        ...
        if 'image_3' in self.output_dict and self.output_dict['image_3']:
            if self.output_dict["image_3"]:
                image_3 = cv2.imread(self.image3_path.replace('image_3', 'lidar_depth'), cv2.IMREAD_UNCHANGED) / 256
                image_3 = image_3[:, :, np.newaxis] 
                image_3 = np.tile(image_3, (1, 1, 3))
            else:
                image_3 =  None
