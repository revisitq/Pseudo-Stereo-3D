...
## path
path = edict()
path.data_path = "/home/chenyinan/Projects/github/LIGA-Stereo/data/kitti/training" # used in visualDet3D/data/.../dataset
path.test_path = "/home/chenyinan/Projects/github/LIGA-Stereo/data/kitti/testing" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "/home/chenyinan/Projects/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/home/chenyinan/Projects/visualDet3D" # or other path for pickle files, checkpoints, tensorboard logging and output files.
if not os.path.isdir(path.project_path):
    os.mkdir(path.project_path)
path.project_path = os.path.join(path.project_path, 'exp/dense')
if not os.path.isdir(path.project_path):
    os.mkdir(path.project_path)
